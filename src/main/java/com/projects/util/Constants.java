...
public final class Constants {
  ...
  public static final String GET_OFFER_DESC = "Funcionalidad que permite obtener la \u00faltima oferta seg\u00fan la fecha de inicio y fecha de fin.";
  ...
  public static final String ACTIVE_DESC = "Activo";
